...
# goerr-gen is a tool that generates error codes for Go projects.
.PHONY: install.goerr-gen
install.goerr-gen:
	@$(GO) install github.com/mingyuans/goerr-gen@v0.4.0


# It is a tool that checks whether the commit message is match the format.
