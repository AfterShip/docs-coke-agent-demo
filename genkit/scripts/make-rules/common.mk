...
# All Commands in cmd directory
COMMANDS ?= $(filter-out %.md %genswaggerdocs, $(wildcard ${ROOT_DIR}/cmd/*))
APPS ?= $(filter-out %.md %pkg, $(wildcard ${ROOT_DIR}/apps/*))
...
CRITICAL_TOOLS ?= swagger mockgen gotests git-chglog github-release go-mod-outdated protoc-gen-go wrk gnuplot
