...
```
  ...
  -d, --doc string                                    The output folder of cmd docs for [32mapiserver[0m.
  ...
  -v, --version version[=true]                        Print version information and quit.
      --wx.address string                             The wechat server address. like 127.0.0.1:8081 (default "http://127.0.0.1:8081")
```
